...
void      macro_tmp(std::string var1="__HISTNAME__",
                   ...
                   std::string file1="../MD_Sherpa200_unweighted_isMu_0_doUnf_1_isSS_0_jetPt_20_Tightjet_0_ZPTweightcorr_1_14_01.root",
                   std::string file2="../MD_Sherpa200_isMu_0_doUnf_1_isSS_0_jetPt_20_Tightjet_0_ZPTweightcorr_1_14_01.root",

//                   std::string file1="../Sherpa200_unweighted_doUnf_0_isSS_0_02_12.root",

//                   std::string file1="Sherpa200_2911_small.root",
//                   std::string file2="MD_DYJetstoLL_inclonly_30_11.root",
//                   std::string file2="../Sherpa200_doUnf_0_isSS_0_02_12.root",
...
double xLowLeg(0.79), xHighLeg(0.89);
  ...
  leg1->SetTextFont(42);
    leg1->AddEntry(data, "Sherpa2.0.0 unweighted ","pe");
    leg1->AddEntry(mc, "Sherpa2.0.0 weighted ","peF");
...
//pt->Draw();
	...
	//  mc->Draw("hhistsames");
	  ...
	  c1->Print("histos_sherpa_5dec/__HISTNAME__.pdf");
	  c1->Print("histos_sherpa_5dec/__HISTNAME__.png");
          c1->Print("histos_sherpa_5dec/__HISTNAME__.C");
...
//pt->Draw();
	...
	//  mc->Draw("hhistsames");
	  ...
	  c2->Print("histos_sherpa_5dec/Linear___HISTNAME__.pdf");
	  c2->Print("histos_sherpa_5dec/Linear___HISTNAME__.png");
          c2->Print("histos_sherpa_5dec/Linear___HISTNAME__.C");
}
