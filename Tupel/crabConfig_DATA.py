...
config.General.requestName = 'test60data_20160304_new'
...
config.JobType.psetName = 'simple_run_data_jecv7_cfg.py'
...
config.Data.outputDatasetTag = 'SingleMuon_Run2015D-PromptReco-v4_JECv7'
