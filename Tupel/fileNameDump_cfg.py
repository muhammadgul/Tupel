...
process.patJetsUpdated = cms.EDProducer("PATJetUpdater",
    addJetCorrFactors = cms.bool(True),
...
process.makePatJetsUpdated = cms.Sequence(process.patJetCorrFactorsUpdated+process.patJetsUpdated)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('74X_dataRun2_v2'),
    toGet = cms.VPSet()
)
