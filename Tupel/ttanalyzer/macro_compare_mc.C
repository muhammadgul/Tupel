...
TFile *mc_o = TFile::Open("mc_amc_hpp_signal_isElec_"+iselec+".root");
TFile *mc_oph = TFile::Open("mc_powheg_hpp_signal_isElec_"+iselec+".root");
...
TLegend *leg1 = new TLegend(0.6931567,0.453719,0.94980511,0.685385);
leg1->SetBorderSize(0);
leg1->SetFillColor(kWhite);
leg1->SetTextSize(0.04);

leg1->AddEntry(hmc_s, "t#bar{t} amc@NLO + HPP","pe");
leg1->AddEntry(hmc_o, "t#bar{t} Powheg + py8","pe");
leg1->AddEntry(hmc_oph, "t#bar{t} Powheg + HPP","pe");
...
*/
          ...
          mont->SetMinimum(0);
          mont->SetMaximum(2);
          mont->SetYTitle("amc+HPP/other");
          fixsplithist(hmc_s,mont);
          TString a;
          a+=setlog;
          c1->Print("stack_plots_amcnlo_powheg/" + var +"_logy_" + a + "_iselec_" + iselec+ ".pdf");
          c1->Print("stack_plots_amcnlo_powheg/" + var +"_logy_" + a + "_iselec_" + iselec+ ".png");
          c1->Print("stack_plots_amcnlo_powheg/" + var +"_logy_" + a + "_iselec_" + iselec+ ".root");
}
...
*/
         ...
         //  l->SetLineColor(kBlue);
          ...
          TString a;
          a+=setlog;
          c1->Print("stack_plots_amcnlo_powheg/" + var + var2+"_logy_" + a + "_iselec_" + iselec+".pdf");
          c1->Print("stack_plots_amcnlo_powheg/" + var + var2+"_logy_" + a + "_iselec_" + iselec+ ".png");
          c1->Print("stack_plots_amcnlo_powheg/" + var + var2+"_logy_" + a + "_iselec_" + iselec+ ".root");
}
...
*/
         ...
         //  l->SetLineColor(kBlue);
          ...
          TString a;
          a+=setlog;
          c1->Print("stack_plots_amcnlo_powheg/" + var + var2+"_logy_" + a + "_mu_elec_comb_.pdf");
          c1->Print("stack_plots_amcnlo_powheg/" + var + var2+"_logy_" + a + "_mu_elec_comb_.png");

}


void macro_compare_mc(){
