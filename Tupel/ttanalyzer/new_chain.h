...
#ifdef new_chain_cxx
new_chain::new_chain(TTree *tree) : fChain(0) 
{
...
Int_t new_chain::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t new_chain::LoadTree(Long64_t entry)
{
...
void new_chain::Init(TTree *tree)
{
...
void new_chain::Show(Long64_t entry)
{
...
Int_t new_chain::Cut(Long64_t entry)
{
