...
BTagCalibrationReader reader(&calib,               // calibration instance
 ...
 standalone_LumiReWeighting puWeight(201525), puUp(201525,1), puDown(201525,-1);
...
//   if(nentries > 1000000)nentries = 1000000;
 ...
 TProfile::SetDefaultSumw2();
   ...
   TProfile* h_profile_pttop_npf= new TProfile ("profile_pttop_npf","profile_pttop_npf",10,pt_tt_range,0,1000);
   TProfile* h_profile_pttop_sumpt= new TProfile ("profile_pttop_sumpt","profile_pttop_sumpt",10,pt_tt_range,0,1000);
   TProfile* h_profile_pttop_avept= new TProfile ("profile_pttop_avept","profile_pttop_avept",10,pt_tt_range,0,1000);

   TProfile* h_profile_pttop_npf_away= new TProfile ("profile_pttop_npf_away","profile_pttop_npf_away",10,pt_tt_range,0,1000);
   TProfile* h_profile_pttop_sumpt_away= new TProfile ("profile_pttop_sumpt_away","profile_pttop_sumpt_away",10,pt_tt_range,0,1000);
   TProfile* h_profile_pttop_avept_away= new TProfile ("profile_pttop_avept_away","profile_pttop_avept_away",10,pt_tt_range,0,1000);

   TProfile* h_profile_pttop_npf_transverse= new TProfile ("profile_pttop_npf_transverse","profile_pttop_npf_transverse",10,pt_tt_range,0,1000);
   TProfile* h_profile_pttop_sumpt_transverse= new TProfile ("profile_pttop_sumpt_transverse","profile_pttop_sumpt_transverse",10,pt_tt_range,0,1000);
   TProfile* h_profile_pttop_avept_transverse= new TProfile ("profile_pttop_avept_transverse","profile_pttop_avept_transverse",10,pt_tt_range,0,1000);

   TProfile* h_profile_pttop_npf_toward= new TProfile ("profile_pttop_npf_toward","profile_pttop_npf_toward",10,pt_tt_range,0,1000);
   TProfile* h_profile_pttop_sumpt_toward= new TProfile ("profile_pttop_sumpt_toward","profile_pttop_sumpt_toward",10,pt_tt_range,0,1000);
   TProfile* h_profile_pttop_avept_toward= new TProfile ("profile_pttop_avept_toward","profile_pttop_avept_toward",10,pt_tt_range,0,1000);

   TProfile* h_profile_ptatop_npf= new TProfile ("profile_ptatop_npf","profile_ptatop_npf",10,pt_tt_range,0,1000);
   TProfile* h_profile_ptatop_sumpt= new TProfile ("profile_ptatop_sumpt","profile_ptatop_sumpt",10,pt_tt_range,0,1000);
   TProfile* h_profile_ptatop_avept= new TProfile ("profile_ptatop_avept","profile_ptatop_avept",10,pt_tt_range,0,1000);

   TProfile* h_profile_ptatop_npf_away= new TProfile ("profile_ptatop_npf_away","profile_ptatop_npf_away",10,pt_tt_range,0,1000);
   TProfile* h_profile_ptatop_sumpt_away= new TProfile ("profile_ptatop_sumpt_away","profile_ptatop_sumpt_away",10,pt_tt_range,0,1000);
   TProfile* h_profile_ptatop_avept_away= new TProfile ("profile_ptatop_avept_away","profile_ptatop_avept_away",10,pt_tt_range,0,1000);

   TProfile* h_profile_ptatop_npf_transverse= new TProfile ("profile_ptatop_npf_transverse","profile_ptatop_npf_transverse",10,pt_tt_range,0,1000);
   TProfile* h_profile_ptatop_sumpt_transverse= new TProfile ("profile_ptatop_sumpt_transverse","profile_ptatop_sumpt_transverse",10,pt_tt_range,0,1000);
   TProfile* h_profile_ptatop_avept_transverse= new TProfile ("profile_ptatop_avept_transverse","profile_ptatop_avept_transverse",10,pt_tt_range,0,1000);

   TProfile* h_profile_ptatop_npf_toward= new TProfile ("profile_ptatop_npf_toward","profile_ptatop_npf_toward",10,pt_tt_range,0,1000);
   TProfile* h_profile_ptatop_sumpt_toward= new TProfile ("profile_ptatop_sumpt_toward","profile_ptatop_sumpt_toward",10,pt_tt_range,0,1000);
   TProfile* h_profile_ptatop_avept_toward= new TProfile ("profile_ptatop_avept_toward","profile_ptatop_avept_toward",10,pt_tt_range,0,1000);

   TProfile* h_profile_mttbar_npf= new TProfile ("profile_mttbar_npf","profile_mttbar_npf",10,pt_tt_range,0,1000);
   TProfile* h_profile_mttbar_sumpt= new TProfile ("profile_mttbar_sumpt","profile_mttbar_sumpt",10,pt_tt_range,0,1000);
   TProfile* h_profile_mttbar_avept= new TProfile ("profile_mttbar_avept","profile_mttbar_avept",10,pt_tt_range,0,1000);

   TProfile* h_profile_mttbar_npf_away= new TProfile ("profile_mttbar_npf_away","profile_mttbar_npf_away",10,pt_tt_range,0,1000);
   TProfile* h_profile_mttbar_sumpt_away= new TProfile ("profile_mttbar_sumpt_away","profile_mttbar_sumpt_away",10,pt_tt_range,0,1000);
   TProfile* h_profile_mttbar_avept_away= new TProfile ("profile_mttbar_avept_away","profile_mttbar_avept_away",10,pt_tt_range,0,1000);

   TProfile* h_profile_mttbar_npf_transverse= new TProfile ("profile_mttbar_npf_transverse","profile_mttbar_npf_transverse",10,pt_tt_range,0,1000);
   TProfile* h_profile_mttbar_sumpt_transverse= new TProfile ("profile_mttbar_sumpt_transverse","profile_mttbar_sumpt_transverse",10,pt_tt_range,0,1000);
   TProfile* h_profile_mttbar_avept_transverse= new TProfile ("profile_mttbar_avept_transverse","profile_mttbar_avept_transverse",10,pt_tt_range,0,1000);

   TProfile* h_profile_mttbar_npf_toward= new TProfile ("profile_mttbar_npf_toward","profile_mttbar_npf_toward",10,pt_tt_range,0,1000);
   TProfile* h_profile_mttbar_sumpt_toward= new TProfile ("profile_mttbar_sumpt_toward","profile_mttbar_sumpt_toward",10,pt_tt_range,0,1000);
   TProfile* h_profile_mttbar_avept_toward= new TProfile ("profile_mttbar_avept_toward","profile_mttbar_avept_toward",10,pt_tt_range,0,1000);

   TProfile* h_profile_mtop_npf= new TProfile ("profile_mtop_npf","profile_mtop_npf",10,pt_tt_range,0,1000);
   TProfile* h_profile_mtop_sumpt= new TProfile ("profile_mtop_sumpt","profile_mtop_sumpt",10,pt_tt_range,0,1000);
   TProfile* h_profile_mtop_avept= new TProfile ("profile_mtop_avept","profile_mtop_avept",10,pt_tt_range,0,1000);

   TProfile* h_profile_mtop_npf_away= new TProfile ("profile_mtop_npf_away","profile_mtop_npf_away",10,pt_tt_range,0,1000);
   TProfile* h_profile_mtop_sumpt_away= new TProfile ("profile_mtop_sumpt_away","profile_mtop_sumpt_away",10,pt_tt_range,0,1000);
   TProfile* h_profile_mtop_avept_away= new TProfile ("profile_mtop_avept_away","profile_mtop_avept_away",10,pt_tt_range,0,1000);

   TProfile* h_profile_mtop_npf_transverse= new TProfile ("profile_mtop_npf_transverse","profile_mtop_npf_transverse",10,pt_tt_range,0,1000);
   TProfile* h_profile_mtop_sumpt_transverse= new TProfile ("profile_mtop_sumpt_transverse","profile_mtop_sumpt_transverse",10,pt_tt_range,0,1000);
   TProfile* h_profile_mtop_avept_transverse= new TProfile ("profile_mtop_avept_transverse","profile_mtop_avept_transverse",10,pt_tt_range,0,1000);

   TProfile* h_profile_mtop_npf_toward= new TProfile ("profile_mtop_npf_toward","profile_mtop_npf_toward",10,pt_tt_range,0,1000);
   TProfile* h_profile_mtop_sumpt_toward= new TProfile ("profile_mtop_sumpt_toward","profile_mtop_sumpt_toward",10,pt_tt_range,0,1000);
   TProfile* h_profile_mtop_avept_toward= new TProfile ("profile_mtop_avept_toward","profile_mtop_avept_toward",10,pt_tt_range,0,1000);

   TProfile* h_profile_matop_npf= new TProfile ("profile_matop_npf","profile_matop_npf",10,pt_tt_range,0,1000);
   TProfile* h_profile_matop_sumpt= new TProfile ("profile_matop_sumpt","profile_matop_sumpt",10,pt_tt_range,0,1000);
   TProfile* h_profile_matop_avept= new TProfile ("profile_matop_avept","profile_matop_avept",10,pt_tt_range,0,1000);

   TProfile* h_profile_matop_npf_away= new TProfile ("profile_matop_npf_away","profile_matop_npf_away",10,pt_tt_range,0,1000);
   TProfile* h_profile_matop_sumpt_away= new TProfile ("profile_matop_sumpt_away","profile_matop_sumpt_away",10,pt_tt_range,0,1000);
   TProfile* h_profile_matop_avept_away= new TProfile ("profile_matop_avept_away","profile_matop_avept_away",10,pt_tt_range,0,1000);

   TProfile* h_profile_matop_npf_transverse= new TProfile ("profile_matop_npf_transverse","profile_matop_npf_transverse",10,pt_tt_range,0,1000);
   TProfile* h_profile_matop_sumpt_transverse= new TProfile ("profile_matop_sumpt_transverse","profile_matop_sumpt_transverse",10,pt_tt_range,0,1000);
   TProfile* h_profile_matop_avept_transverse= new TProfile ("profile_matop_avept_transverse","profile_matop_avept_transverse",10,pt_tt_range,0,1000);

   TProfile* h_profile_matop_npf_toward= new TProfile ("profile_matop_npf_toward","profile_matop_npf_toward",10,pt_tt_range,0,1000);
   TProfile* h_profile_matop_sumpt_toward= new TProfile ("profile_matop_sumpt_toward","profile_matop_sumpt_toward",10,pt_tt_range,0,1000);
   TProfile* h_profile_matop_avept_toward= new TProfile ("profile_matop_avept_toward","profile_matop_avept_toward",10,pt_tt_range,0,1000);
      ...
      //  cout<<" nu1 b1, nu2 b1, nu1 b2, nu2 b2 "<<"  "<<(mu_vector[0]+nu_vector1+jet_vector[b_jet_index[0]]).M()<<"  "<<(mu_vector[0]+nu_vector2+jet_vector[b_jet_index[0]]).M()<<"  "<<(mu_vector[0]+nu_vector1+jet_vector[b_jet_index[1]]).M()<<"  "<<(mu_vector[0]+nu_vector2+jet_vector[b_jet_index[1]]).M()<<endl;
       ...
       for(unsigned int i=0;i<a_min.size();i++){
        ...
        if(mu_charge[0]>0){
          ...
          h_pt_top->Fill(tlep.Pt(),w);
          h_pt_atop->Fill(thad.Pt(),w);
          top_vector=tlep;
          atop_vector=thad;
        }
        ...
        if(mu_charge[0]<0){
          ...
          h_pt_atop->Fill(tlep.Pt(),w);
          h_pt_top->Fill(thad.Pt(),w);
          atop_vector=tlep;
          top_vector=thad;
        }
