...
config.General.requestName = 'test160data'
...
config.Data.inputDataset = '/SingleMuon/Run2015C-23Sep2015-v1/MINIAOD'
...
config.Data.publishDataName = 'SingleMuon_Run2015C-23Sep2015-v1'
